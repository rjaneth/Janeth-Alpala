...
```{r fig-optimal_order,  echo=FALSE, message=FALSE, warning=FALSE,  out.width="70%",  fig.pos="htb", fig.cap="Bias and MSE as a function of $\\lambda$, for the Rényi entropy estimator, with $n = 49$, $L = 5$.", fig.width=5, fig.height=3.0}
#fig.show="hide", 
# eval=FALSE,  # 
...
```{r fig-optimal_order-tsallis,  echo=FALSE, message=FALSE, warning=FALSE,  out.width="70%",  fig.pos="htb", fig.cap="Bias and MSE as a function of $\\lambda$, for the Tsallis entropy estimator, with $n = 49$, $L = 5$.", fig.width=5, fig.height=3.0}
#fig.show="hide", 
# eval=FALSE,  # 
...
```{r fig-bias_mse_rm1,  echo=FALSE, message=FALSE, warning=FALSE,  out.width="65%",  fig.pos="H",  fig.cap="Bias and MSE of the Rényi entropy estimators for $\\Gamma_{\\text{SAR}}$, with $L=5$", fig.width=5.5, fig.height=3.5}
...
```{r fig-bias_mse_Tsallis,  echo=FALSE, message=FALSE, warning=FALSE,  out.width="65%",  fig.pos="htb",  fig.cap="Bias and MSE of the Tsallis entropy estimators for $\\Gamma_{\\text{SAR}}$, with $L=5$", fig.width=5.5, fig.height=3.6}
