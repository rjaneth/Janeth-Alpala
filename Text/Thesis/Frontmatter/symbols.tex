...
{%
\setlength{\extrarowheight}{0.5pt}   % extra vertical por fila
\renewcommand{\arraystretch}{1.18} % factor global para altura de filas (1.0 = normal)

\begin{symbols}{@{}lll@{}} % @{} opcional: elimina márgenes laterales de la tabla
...
\addlinespace[4pt] % (opcional) espacio extra para separar bloques
\end{symbols}
}% --- fin del ámbito local ---
