...
<!-- JA: I used three different color gradients in the p-value maps to enhance visual contrast across the scenes. I can unify the maps using the same color scale if preferred. -->
```{=latex}
\begin{figure*}[hbt]
    \centering
