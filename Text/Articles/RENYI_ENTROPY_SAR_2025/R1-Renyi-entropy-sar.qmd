...
<!-- New color  Palettes viridis B (inferno) -->
```{=latex}
\begin{figure*}[hbt]
    \centering
    ...
    \begin{subfigure}{0.179\textwidth}
        \includegraphics[width=\linewidth]{./Figures-R1/p-values_renyi-london_B1.png}
   ...
   \hspace{0.00001\textwidth}
    \begin{subfigure}{0.18\textwidth}
        \includegraphics[width=\linewidth]{./Figures-R1/p-values_shannon-london_B1.png}
...
\begin{figure*}[hbt]
  ...
  \begin{subfigure}{0.137\textwidth}
    ...
    \begin{subfigure}{0.178\textwidth}
        \includegraphics[width=\linewidth]{./Figures-R1/p-values_renyi-munich-B.png}
        \caption{$p$-value map for $\small{S_{\widetilde{H}_{\lambda}}}$}
    ...
    \hspace{0.00001\textwidth}
    \begin{subfigure}{0.178\textwidth}
        \includegraphics[width=\linewidth]{./Figures-R1/p-values_shannon-munich-B.png}
