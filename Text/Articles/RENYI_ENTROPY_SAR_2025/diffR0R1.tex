...
%DIF ADD R1-Renyi-entropy-sar.tex   Wed Jun  4 15:59:17 2025
...
% The paper headers
\DIFdelbegin %DIFDELCMD < \markboth{Journal XXX, Month Year}{}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \markboth{IEEE Geoscience and Remote Sensing Letters, Month Year}{}
\DIFaddend 
...
\begin{abstract}
Quantifying \DIFdelbegin \DIFdel{surface roughness }\DIFdelend \DIFaddbegin \DIFadd{heterogeneity }\DIFaddend in synthetic aperture radar (SAR) data is
...
estimation of Rényi entropy to characterize \DIFdelbegin \DIFdel{surface roughness }\DIFdelend \DIFaddbegin \DIFadd{return heterogeneity }\DIFaddend from
SAR intensity data. The statistic is refined using bootstrap to improve
its stability, size, and power. This approach enhances \DIFdelbegin \DIFdel{roughness
}\DIFdelend \DIFaddbegin \DIFadd{heterogeneity
}\DIFaddend quantification by capturing scale-dependent variations and addressing
data-driven uncertainty. Experimental results \DIFdelbegin \DIFdel{demonstrate }\DIFdelend \DIFaddbegin \DIFadd{establish }\DIFaddend the robustness
of the proposed method in distinguishing \DIFdelbegin \DIFdel{roughness patterns, offering a
statistically rigorous tool for SAR-based terrain analysis}\DIFdelend \DIFaddbegin \DIFadd{heterogeneity patterns}\DIFaddend .
\end{abstract}
...
intensity data because it captures different \DIFdelbegin \DIFdel{roughness }\DIFdelend \DIFaddbegin \DIFadd{heterogeneity }\DIFaddend levels. A
...
describe \DIFdelbegin \DIFdel{roughness~\mbox{%DIFAUXCMD
\citeproc{ref-Frery1997}{{[}14{]}}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{varying levels of
heterogeneity~\mbox{%DIFAUXCMD
\citeproc{ref-Frery1997}{{[}12{]}}}\hskip0pt%DIFAUXCMD
}\DIFaddend . These distributions
are characterized by the following probability density functions (pdfs):
\begin{equation}
...
the \DIFdelbegin \DIFdel{roughness}\DIFdelend \DIFaddbegin \DIFadd{heterogeneity}\DIFaddend , \(L \geq 1\) is the number of looks,
\(\Gamma(\cdot)\) is the gamma function, and \(\mathbbm 1_{A}(z)\) is
the indicator function of the set \(A\). The \(\Gamma_{\text{SAR}}\) \DIFdelbegin \DIFdel{model }\DIFdelend \DIFaddbegin \DIFadd{law
}\DIFaddend is a particular case of the \(\mathcal{G}^0_I\)
...
terms that depend on the roughness parameter\(\alpha\). As
\(\alpha \to -\infty\), these terms tend }\DIFdelend \DIFaddbegin \DIFadd{Equation~\eqref{eq-HGI0} can be read as: }\[
...
\DIFadd{where the excess term \(\Delta_\alpha\) depends on the heterogeneity
parameter. When \(\alpha\!\to\!-\infty\) (fully developed speckle), this
...
%DIFDELCMD < \includegraphics[width=0.45\textwidth,height=\textheight]{R0-Renyi-entropy-sar_files/figure-pdf/fig-plot-1.pdf}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.35\textwidth,height=\textheight]{R0-Renyi-entropy-sar_files/figure-pdf/fig-density_entropyR_standardized0-1.pdf}
%DIFDELCMD < 
...
where darker regions indicate areas with higher \DIFdelbegin \DIFdel{roughness}\DIFdelend \DIFaddbegin \DIFadd{heterogeneity}\DIFaddend , and
lighter regions denote \DIFdelbegin \DIFdel{smoother, }\DIFdelend less textured surfaces. The binary maps
...
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/london_2000.png}
%DIFDELCMD <         %%%
...
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_pvalue_london_renyi.png}
%DIFDELCMD <         %%%
...
\DIFdelendFL \DIFaddbeginFL \label{fig:london-renyi}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.17\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_london_renyi_L1_.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:london-005-renyi}
    \DIFaddendFL \end{subfigure}
   \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.22\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_pvalue_london_Shannon_c1.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:london-shann}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.17\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_london_shannon.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
    }\begin{subfigure}{0.145\textwidth}
...
\begin{figure*}[hbt]
    \centering
        \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.17\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/munich_1024_2.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \begin{subfigure}{0.145\textwidth}
...
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_pvalue_muni_renyi.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
...
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_munich_renyi.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:munich-005-renyi}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.23\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_pvalue_muni_Shan22.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
    }\begin{subfigure}{0.178\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:munich-shann}
    \DIFaddendFL \end{subfigure}
   \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.16\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_munich_sh_AO_L12.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
    }\begin{subfigure}{0.144\textwidth}
...
\begin{figure*}[hbt]
    \centering
        \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.16\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/dublin_1100_hh.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \begin{subfigure}{0.145\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:dublin-sar}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.22\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/dublin_renyi_09_w7_b100.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
}\begin{subfigure}{0.145\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:dublin-renyi}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.16\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_dublin_renyi_09_w7_b100.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
    }\begin{subfigure}{0.144\textwidth}
...
\DIFdelendFL \DIFaddbeginFL \label{fig:dublin-005-renyi}
    \DIFaddendFL \end{subfigure}
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.22\textwidth}
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/AO_w7_L16_b100.png}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\hspace{0.00001\textwidth}
    }\begin{subfigure}{0.178\textwidth}
...
%DIFDELCMD <         \includegraphics[width=\linewidth]{./Figures/H_005_AO_w7_L16_b100.png}
%DIFDELCMD <         \caption{%%%
