...
\begin{figure*}[t]
    ...
    \begin{subfigure}{0.30\textwidth}
        \includegraphics[width=\linewidth]{./Figures/H_pvalue_munich_c2.png}
        \caption{$p$-values}
        \label{fig:1c}
    \end{subfigure}
    \begin{subfigure}{0.20\textwidth}
        \includegraphics[width=\linewidth]{./Figures/H_005_4z_7w_300b.png}
        \caption{ Binary map $5\%$ }
        \label{fig:1d}
    \end{subfigure}
...
\begin{figure*}[t]
    \centering
    \begin{subfigure}{0.19\textwidth}
        \includegraphics[width=\linewidth]{./Figures/munich_512_.png}
        \caption{ SAR image}
        \label{fig:1a}
    \end{subfigure}
    \begin{subfigure}{0.30\textwidth}
        \includegraphics[width=\linewidth]{./Figures/H_pvalue_munich_c4.png}
        \caption{$p$-values}
        \label{fig:1c}
    \end{subfigure}
    \begin{subfigure}{0.20\textwidth}
        \includegraphics[width=\linewidth]{./Figures/H_005_munich.png}
        \caption{ Binary map $5\%$ }
        \label{fig:1d}
    \end{subfigure}
