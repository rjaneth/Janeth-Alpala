...
\end{equation}
%where the elements $S_{\text{HH}}$ and $S_{\text{VV}}$ are the returned power in the co-polarized channels, while the elements $S_{\text{HV}}$ and $S_{\text{VH}}$ relate to the cross-polarized channels. %If the PolSAR targets comply with the reciprocal condition $(S_{\text{HV}} = S_{\text{VH}})$, 
...
\vspace{-0.2cm}
\subsection{Fusion methods for edge evidence}%\vspace{-0.1cm}
...
\begin{minipage}[b]{1.0\linewidth}
  \centering
 \centerline{\epsfig{figure=../../../Figures/PDF/hh.pdf,width=3.9cm}}
  \vspace{-0.1cm}
...
\begin{minipage}[b]{.48\linewidth}
  \centering
\centerline{\epsfig{figure=../../../Figures/PDF/hv.pdf,width=3.9cm}}
  \vspace{-0.1cm}
...
\begin{minipage}[b]{0.48\linewidth}
  \centering
 \centerline{\epsfig{figure=../../../Figures/PDF/vv.pdf,width=3.8cm}}
  \vspace{-0.1cm}
...
\begin{minipage}[b]{.48\linewidth}
  \centering
\centerline{\epsfig{figure=../../../Figures/PDF/pca.pdf,width=3.9cm}}
  \vspace{-0.1cm}
...
\begin{minipage}[b]{0.48\linewidth}
  \centering
 \centerline{\epsfig{figure=../../../Figures/PDF/roc.pdf,width=3.9cm}}
  \vspace{-0.1cm}
