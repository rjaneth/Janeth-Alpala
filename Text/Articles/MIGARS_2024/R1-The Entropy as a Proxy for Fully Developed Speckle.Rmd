...
knitr::include_graphics("../../../Figures/PNG/BER_Intensity_VV.jpg")
```

```{r SAR_simulations, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
...
entropia_estimada_boot_brasil <- bootstrap_correa_estimator( roi_Brazil, 10)
True_entropy_brasil <-(log(mean( roi_Brazil)) + (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
Test_difference_brasil <- bootstrap_correa_estimator_log_mean( roi_Brazil, 10)- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
#difference_correa_brasil <- correa_estimator( roi_Brazil) - log(mean(roi_Brazil))- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
...
entropia_estimada_boot_Berlin <- bootstrap_correa_estimator( roi_Berlin, 10)
True_entropy_Berlin <-(log(mean( roi_Berlin)) + (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
Test_difference_Berlin <- bootstrap_correa_estimator_log_mean( roi_Berlin, 10)- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
#difference_correa_Berlin <- correa_estimator( roi_Berlin) - log(mean(roi_Berlin))- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
...
entropia_estimada_boot_Flevoland <- bootstrap_correa_estimator( roi_Berlin, 10)
True_entropy_Flevoland <-(log(mean( roi_Flevoland)) + (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
Test_difference_Flevoland <- bootstrap_correa_estimator_log_mean( roi_Flevoland, 10)- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
#difference_correa_Flevoland <- correa_estimator( roi_Flevoland) - log(mean(roi_Flevoland))- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
...
centerCol_Ottawa  <- floor(nCols_Ottawa  / 2)
 ...
 roiSize_Ottawa <- 100
# 
# # Coordenadas del ROI en la parte superior
 roiUpperStartRow <- 1
...
# 
# # Extraer el ROI en la parte superior
 ...
 entropia_estimada_boot_Ottawa <- bootstrap_correa_estimator( roi_Ottawa, 10)
 True_entropy_Ottawa <-(log(mean( roi_Ottawa)) + (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
 Test_difference_Ottawa <- bootstrap_correa_estimator_log_mean( roi_Ottawa, 10)- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
 #difference_correa_Ottawa <- correa_estimator( roi_Ottawa) - log(mean(roi_Ottawa))- ( (5 - log(5) + lgamma(5) + (1 - 5) * digamma(5)))
