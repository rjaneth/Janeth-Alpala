...
save(results_gi0, file = "./Data/resultsgi0.Rdata")
...
We used $7 \times 7$ local sliding windows for the test. In Fig.&nbsp;\ref{fig:Real_SAR_Images}(b), $p$-values higher than a $10\%$ significance level are shown. This approach allows to emphasize regions where there is not enough evidence against the null hypothesis. The new image reveals two distinct regions: darker background indicates homogeneity, while lighter backgrounds represent heterogeneous areas.
...
knitr::include_graphics("../../../Figures/PNG/pvalue7x7-10.png")
