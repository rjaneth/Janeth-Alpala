...
imagematrix_colorPNG <- function(x, name,
  ...
  image.plot(zlim = c(0,1), legend.only = TRUE, col = palette_colors,
             horizontal = FALSE,
             smallplot = c(0.26, 0.56, 0.02, 0.98),# munich c(0.2, 0.53, 0.02, 0.98) phantom = c(0.25, 0.54,  0.02, 0.98),#phamtomc#munich(0.3, 0.5, 0.02, 0.98),
             axis.args = list(at = ticks, labels = labels, cex.axis = 4.0)) #1.5: phantom 3.1 munich
  dev.off()
  }
#   #foggia
#   par(oma = c(0,0,0,0), mar = c(0,0,0,0))
...
#   image.plot(zlim = c(0,1), legend.only = TRUE, col = palette_colors,
#              horizontal = FALSE,
#              smallplot = c(0.23, 0.57, 0.02, 0.98),# munich c(0.2, 0.53, 0.02, 0.98) phantom = c(0.25, 0.54,  0.02, 0.98),#phamtomc#munich(0.3, 0.5, 0.02, 0.98),
#              axis.args = list(at = ticks, labels = labels, cex.axis = 5.8)) #1.5: phantom 3.1 munich
#   dev.off()
# }
...
# image.plot(zlim = c(0,1), legend.only = TRUE, col = palette_colors,
#            horizontal = FALSE,
#            smallplot = c(0.25, 0.57, 0.02, 0.98),# munich c(0.2, 0.53, 0.02, 0.98) phantom = c(0.25, 0.54,  0.02, 0.98),#phamtomc#munich(0.3, 0.5, 0.02, 0.98),
#            axis.args = list(at = ticks, labels = labels, cex.axis = 4.8)) #1.5: phantom 3.1 munich
# dev.off()
# }
...
#   par(oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0))
  ...
  #                #at     = sort(unique(c(seq(0, 1, by = 0.2), significance_level))),
  #                #labels = as.character(sort(unique(c(seq(0, 1, by = 0.2), significance_level)))),
  #                cex.axis = 3.3 # 3.3 dublin 3.3, 3.1 munich, 2.1 mexico
  #              ))
  #   dev.off()
  # }
  #   #mexico
