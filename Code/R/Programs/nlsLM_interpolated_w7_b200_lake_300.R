...
# x <- myread.ENVI(file='../../../Data/SAR/envi_SF_400/Intensity_VV.img', 
#                  headerfile='../../../Data/SAR/envi_SF_400/Intensity_VV.hdr')

 x <- myread.ENVI(file='../../../Data/SAR/lake_300/Intensity_VV.img', 
                  headerfile='../../../Data/SAR/lake_300/Intensity_VV.hdr')
...
B <- 200               # Increased number of bootstrap samples
...
save(p_values_nlsLM,p_values_nlsLM_interpolated, x, file = "./Data/p_values_nlsLM_interpolated_w11_b200_lake_300_.Rdata")

# Load the p-values if necessary
# 
load("./Data/p_values_nlsLM_interpolated_w7_b200_lake_300_.Rdata")

# Create a data frame for plotting
p_values_df <- melt(p_values_nlsLM_interpolated, varnames = c("Row", "Col"), value.name = "p_value")
...
heterogeneous_regions <- p_values_nlsLM_interpolated < 0.05
