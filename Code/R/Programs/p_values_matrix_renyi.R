...
mean_difference_values <- mean(difference_values_renyi, na.rm = TRUE)
sd_difference_values <- sd(difference_values_renyi, na.rm = TRUE)


p_values_matrix <- calculate_p_values_matrix(difference_values_renyi, mean_difference_values, sd_difference_values)

#save(p_values_matrix, file = "./Data/results_pvalue_Phantom_4_renyi.Rdata")
